...
## Overview  
DriveIt is a full-stack MERN application that enables users to browse, book, and purchase vehicles online.  
...
- *Bookings*:  
  - Test drive booking.  
  - Service and vehicle booking with history tracking.  
